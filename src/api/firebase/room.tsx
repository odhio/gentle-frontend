...
export const pushChatMessageEmotion = async (
  roomId: string,
  chatMessagePK: string,
  emotion: EmotionLabel,
) => {
  if (
    emotion.result === (null || undefined) ||
    emotion.pressure === (null || undefined)
  )
    return
...
export const addRoomSummary = async (
  ...
  const roomRef = ref(db, 'rooms/' + roomId)
  await update(roomRef, { summary: summary } satisfies Required<
    Pick<Room, 'summary'>
  >)
}
