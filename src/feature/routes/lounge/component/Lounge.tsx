            ...
            >
              <CardHeader>
                <Heading size="md" mb={3} display={'inline-block'}>
                  {sprint.createdAt ? 'yyyy/mm/dd HH:MM' : 'yyyy/mm/dd HH:MM'}{' '}
                  {/*仮置き*/}
                </Heading>
                <Text>
                  参加者
              ...
              <CardBody>
                <Text>
                  {sprint.summary ? 'xxxxxxxxxについて話し合われました' : ''}
                </Text>
              </CardBody>
              <CardFooter>
                {sprint.closedAt ? (
                  ...
                  <HStack spacing={4}>
                    ...
                    <Button
                      as="a"
                      href={`/room/${sprintData?.id}?roomId=${sprintData?.roomId}`}
                    >
                      参加
                    </Button>
                  </HStack>
